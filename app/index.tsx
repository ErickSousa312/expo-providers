...
export default function TabOneScreen() {
  ...
  return (
    ...
    <View style={{backgroundColor:'#00000000', width:250, height:210, alignItems:'center', marginTop:100}}>
    <Image
        style={styles.image}
        source={dolar}
      ...
      <View style={{backgroundColor:'whites', marginTop:30}}>
        <Text style={styles.labelData}>R$ {coinData && parseFloat(coinData[0].ask).toFixed(2) } </Text>
      </View>
      ...
      <View style={styles.divButtons}>
        <Pressable style={styles.buttom} onPress={()=>{
          ...
          <Text style={{color:'black',fontWeight:400, fontSize:20}} >Atualizar</Text>
        </Pressable>
      </View>
